...
const WoFIVContainer: React.FC = () => {
  ...
  useEffect(() => {
    if (hasUnsavedChanges) {
      sessionStorage.setItem('wofiv_has_unsaved_changes', 'true');
      console.log('*** SETTING WOFIV UNSAVED CHANGES FLAG IN SESSIONSTORAGE ***');
    } else {
      sessionStorage.removeItem('wofiv_has_unsaved_changes');
      console.log('*** REMOVING WOFIV UNSAVED CHANGES FLAG FROM SESSIONSTORAGE ***');
    }
    ...
    return () => {
      ...
      console.log('*** CLEANING UP WOFIV UNSAVED CHANGES FLAG ON COMPONENT UNMOUNT ***');
    };
  }, [hasUnsavedChanges]);
  ...
  useEffect(() => {
    const handlePopState = (e: PopStateEvent) => {
      console.log('*** WOFIV COMPONENT: POPSTATE EVENT FIRED ***');
      console.log('*** WOFIV COMPONENT: hasUnsavedChanges =', hasUnsavedChanges, '***');
      
      if (hasUnsavedChanges) {
        console.log('*** WOFIV COMPONENT: UNSAVED CHANGES DETECTED - SHOWING CONFIRMATION ***');
        ...
        if (!confirmed) {
          console.log('*** WOFIV COMPONENT: USER CANCELLED - PREVENTING NAVIGATION ***');
          ...
          console.log('*** WOFIV COMPONENT: SETTING NAVIGATION FLAG AFTER CANCELLING POPSTATE ***');
        } else {
          console.log('*** WOFIV COMPONENT: USER CONFIRMED - ALLOWING NAVIGATION ***');
          ...
          console.log('*** WOFIV COMPONENT: ALLOWING NATURAL NAVIGATION ***');
          navigate('/document-upload', { state: { from: 'wofiv' } });
        }
      } else {
        console.log('*** WOFIV COMPONENT: NO UNSAVED CHANGES - ALLOWING NAVIGATION ***');
    ...
    if (hasUnsavedChanges) {
      console.log('*** WOFIV COMPONENT: ADDING POPSTATE LISTENER FOR UNSAVED CHANGES ***');
    ...
    if (!isInitializing) {
      ...
      const hasActualChanges = Object.keys(data).some(key => {
        ...
        if (typeof newValue === 'object' && newValue !== null) {
          // For nested objects like wohnflaecheFloors, do deep comparison
